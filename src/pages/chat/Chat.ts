...
interface ChatProps {
  ...
  user: () => User, // eslint-disable-line no-undef
  messages: () => Array<Message>, // eslint-disable-line no-undef
  ...
  constructor(props) { // eslint-disable-line no-unused-vars
    super({
      ...
      handleSelectChat: (event: Event) => {
        ...
        this.props.selectedId = newSelectedId
        this.props.selected = true
        this.props.store.dispatch(getUsers, newSelectedId)
        this.props.store.dispatch(chatRoom, {
          chatId: newSelectedId,
